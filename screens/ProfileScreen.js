          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.infoSection}>
              ...
              <TouchableOpacity
                ...
                onPress={() => handleEditField("age", profileData?.age?.toString())}
              >
            ...
            <View style={styles.actionsSection}>
              ...
              {/* Removing this non-functional button */}
            ...
            <View style={styles.modalContainer}>
              <View style={[styles.modalContent, { alignItems: "center" }]}>
                ...
                <View style={styles.formGroup}>
                  <Text style={styles.inputLabel}>{editField.charAt(0).toUpperCase() + editField.slice(1)}</Text>
                  <TextInput
                    style={styles.input}
                    value={inputValue}
...
const styles = StyleSheet.create({
  ...
  modalContainer: {
    ...
    backgroundColor: "rgba(0, 0, 0, 0.7)", // Darken the background overlay
  ...
  formGroup: {
    ...
    position: "relative", // For positioning the unit text
  },
  input: {
    ...
    borderWidth: 1,
    borderColor: "rgba(0, 255, 255, 0.3)", // Add cyan border
  },
  saveButton: {
